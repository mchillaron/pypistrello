...
def compute_sim_snr(table, area_column, simulation_results): #real_table
    ...
    #real_flux = real_table["area_trapz"]        # (L, 1) is 1D
    real_flux = table[area_column]

    #find the column index of the area_column in the table
    area_col_index = table.colnames.index(area_column)
